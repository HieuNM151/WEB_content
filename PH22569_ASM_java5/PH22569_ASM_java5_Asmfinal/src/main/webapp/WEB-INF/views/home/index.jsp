						...
						<div class="col-12 col-sm-12 col-md-12 col-lg-12">
							<ul class="display-table store-info">
								<li class="display-table-cell"><i
									...
									<h5>Cầm tay chỉ việc</h5> <span class="sub-text"> Đối
										với khách hàng mới, thân thiết hoặc content có trị giá từ 500k </span></li>
								<li class="display-table-cell"><i
									class="icon anm anm-comments-l"></i>
									<h5>Đảm bảo bản quyền</h5> <span class="sub-text">
										Sẵn sàng hỗ trợ bất cứ lúc nào nếu bị đánh gậy </span></li>
								<li class="display-table-cell"><i
									class="icon anm anm-money-bill-ar"></i>
									<h5>Nói không với content bẩn</h5> <span class="sub-text"> Cam
										kết hoàn tiền 300% nếu phát hiện content bẩn</span></li>
							</ul>
						</div>
					</div>
				</div>
